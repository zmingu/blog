...
![](https://blog.zmingu.com/usr/uploads/2025/05/eae940acd9d156a22f7d1655bb2c228b_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/c19c05beb30b0185b36a20a037ab4bf1_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/2231fc2c0e3a6c21f65b2651e3b70c63_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/e0a466a976db875dd96d491f8632e042_MD5.webp)

注意，必须重载运算符<<和>>。标准C++使用头文件complex提供 了比这个示例更广泛的复数支持，因此应将自定义的头文件命名为 complex0.h，以免发生冲突。应尽可能使用const。

下面是该程序的运行情况。

![](https://blog.zmingu.com/usr/uploads/2025/05/6518e22a54bb7f5e180ff019d344f2fc_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/6ce1722c5992d6306eb3f5614c684ab6_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/507bf78c85b98e92fa80043e6b2fca47_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/c8ea088cf85bd4cc373a6b54c8130b80_MD5.webp)

输出应与下面相似:

![](https://blog.zmingu.com/usr/uploads/2025/05/f2603f638fe850f68a6ef35727f2c725_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/3a284e7aacd619cb95322da6d6474092_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/6f821aa83818f8b3137ef647fa695a5a_MD5.webp)

派生出一个Classic类，并添加一组char成员，用于存储指出CD中主 要作品的字符串。修改上述声明，使基类的所有函数都是虚的。如果上 述定义声明的某个方法并不需要，则请删除它。使用下面的程序测试您 的产品:

![](https://blog.zmingu.com/usr/uploads/2025/05/e856271c25ea5d0496348cd2019c6b3c_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/240de92e5578022ca2a6b329f548a6db_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/68e1c696ea7254f44b752d2a29d1bc6e_MD5.webp)

show( )方法按下面的格式显示信息:

![](https://blog.zmingu.com/usr/uploads/2025/05/fe1a253622d127522ac322958b5ea703_MD5.webp)

`operator<<()` 函数按下面的格式显示信息(末尾没有换行符):

![](https://blog.zmingu.com/usr/uploads/2025/05/9a5dcac79f93c10032babf665cdb8bc9_MD5.webp)

PortMaster完成了Port类的方法定义后派生了VintagePort类，然后被 解职——因为不小心将一瓶45度Cockburn泼到了正在准备烤肉调料的人 身上，VintagePort类如下所示:

![](https://blog.zmingu.com/usr/uploads/2025/05/d596e154832025afad4e112a573146f6_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/3945671aaa3a85d56b39b9baf8b58315_MD5.webp)

这样，`PairArray` 表示的是类型 `Pair<std::valarray<int>, std::valarray<int> >`。使用包含来实现 `Wine` 类，并用一个简单的程序对其 进行测试。`Wine` 类应该有一个默认构造函数以及如下构造函数:

![](https://blog.zmingu.com/usr/uploads/2025/05/b27446b5aa93930ec5986182186ed97e_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/d5d2d6e0cd6e417914d263e5c6d84672_MD5.webp)

下面是该程序的运行情况:

![](https://blog.zmingu.com/usr/uploads/2025/05/2285f644308421ac19f194d6fc2d02db_MD5.webp)

## 14.2 

**题：** 采用私有继承而不是包含来完成编程练习1。同样，一些typedef 可能会有所帮助，另外，您可能还需要考虑诸如下面这样的语句的含义:

![](https://blog.zmingu.com/usr/uploads/2025/05/d80762e9b705ca7a166ada867c7a19bd_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/5573ec3b799068744beb0bbbab6c9ebc_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/cf2b881ede56e43eea949b69519f5c09_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/672786e11c192482d15d9efcf43f7f60_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/1eb0e532e45525ed50c54d42be1c783f_MD5.webp)

![](https://blog.zmingu.com/usr/uploads/2025/05/2f4ac21461fbac9c4a6d765224262972_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/9b504fcaa01ec17bccb2a824f3ce1991_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/68ddd81b94888f9e78cb9a4289caa663_MD5.webp)


而第二个输入文件的内容如下:

![](https://blog.zmingu.com/usr/uploads/2025/05/7db91fdfa412b6be5b8ea3221247b61f_MD5.webp)

则得到的文件的内容将如下:

![](https://blog.zmingu.com/usr/uploads/2025/05/bdfba2b9432c3b0eec177b4d96d9b437_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/7ad4898d080b53fdec3c890535860d67_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/9d7c327d5e0bf0ac440b8f112bcd5729_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/7f3a545276f2603de962c7f48b2757ca_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/40b58583d77bc2085e6485ffd1fabb64_MD5.webp)
...
![](https://blog.zmingu.com/usr/uploads/2025/05/7c2bc4ea7a456f1f2f86b4f9eb9e6c78_MD5.webp)
